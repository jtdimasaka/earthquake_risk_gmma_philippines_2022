...
% exposure.pop.mean = table2array(data(:,44)).*13484462./11855975;
exposure.pop.mean = exposure.popdensity.mean .* exposure.Area.polygon ./ 1e6;
exposure.pop.stdv = exposure.popdensity.stdv .* exposure.Area.polygon ./ 1e6;
